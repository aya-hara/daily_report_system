...
public class EmployeeValidator {
     ...
     * @param codeDuplicateCheckFlag 社員番号の重複チェック
     * @param passwordCheckFlag パスワードの入力チェックを実装
     * @return エラーのリスト
     */
    ...
    /**　PWの入力チェックを行い、エラーメッセージを返却
     * @param password　パスワード
     * @param passwordCheckFlag パスワードの入力チェックを実施する
     * @return エラーメッセージ
     */

    private static String validatePassword(String password, Boolean passwordCheckFlag) {

        //入力チェックを実施かつ入力値がない場合はエラーメッセージを返却
