...
public class EmployeeService extends ServiceBase{
    ...
    */
    ...
    /**社員番号、PWを条件に取得したデータをEmployeeViewのインスタンスで返却する
     * @param code 社員番号
    ...
    public EmployeeView findOne(String code,String plainPass, String pepper) {
        ...
        try {
            ...
            //社員番号とハッシュ化済PWを条件に未削除の従業員を1件取得する
    ...
    /** 画面から入力された従業員の登録内容をもとにデータを1件返却する
